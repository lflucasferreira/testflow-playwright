...
- Complete guide (EN): `https://lflucasferreira.github.io/testflow-playwright/complete-guide.html`
- Guia completo (PT): `https://lflucasferreira.github.io/testflow-playwright/guia-completo.html`
- Slides: `https://lflucasferreira.github.io/testflow-playwright/slides/`
...
- **Docs hub (local):** `npm run slides` → http://localhost:3335/docs/
- **Pages URLs** mirror pytest: hub and guides at site root when built with `npm run pages:build`
